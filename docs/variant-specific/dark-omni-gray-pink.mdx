...
- Dark omni cards "inherit" all of the conventions from the base suits (e.g. [dark pink conventions](dark-pink.mdx), [black conventions](black.mdx), [omni conventions](omni.mdx)).
  - However, [Soft Good Touch Principle](omni.mdx#soft-good-touch-principle) obviously does not apply to dark cards.
...
- Dark omni or gray pink 3's and 4's on chop should be saved with a number 5 clue.
...
- First, see the section on the _[Fake 5's Chop Move](dark-pink.mdx#the-fake-5s-chop-move)_ & the _[Fake 5 Pull](dark-pink.mdx#the-fake-5-pull--the-fake-5-number-discharge)_ (in variants with a dark pink suit).
